...
public class WalkRouteOverlay extends RouteOverlay {
	 ...
	 *                <strong><a href="../../../../../../Search/com/amap/api/services/route/
	 *                WalkStep.html" title="com.amap.api.services.route中的类">WalkStep</a></strong>。
	 * @param start 起点。详见搜索服务模块的核心基础包（com.amap.api.services.core）中的类<strong>
	 *                 <a href="../../../../../../Search/com/amap/api/services/core/
	 *                 LatLonPoint.html" title="com.amap.api.services.core中的类">LatLonPoint</a>
	 * </strong>。
	 * @param end 终点详见搜索服务模块的核心基础包（com.amap.api.services.core）中的类<strong>
	 *               <a href="../../../../../../Search/com/amap/api/services/core/LatLonPoint.html"
	 *               title="com.amap.api.services.core中的类">LatLonPoint</a>
	 * </strong>。
	 * @since V2.1.0
	 */
